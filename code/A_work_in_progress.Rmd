...
Questa prima mappa ci mostra i comuni dove, per l'alto numero di anziani, è utile implementare servizi di medicina territoriale. 
Chiaramente il numero assoluto di anziani dipende dalla popolosità del comune.
...
### Percentuale di anziani con più di 65 anni per comune (solo comuni con più di 3000 abitanti) con servizi territoriali
